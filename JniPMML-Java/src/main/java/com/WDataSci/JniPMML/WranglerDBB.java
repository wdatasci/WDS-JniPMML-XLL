    ...
    public class WranglerDBB
    {
        ...
        throws com.WDataSci.WDS.WDSException
        {
            try {
                ...
                //Java
                Boolean bUsingPMML = (aJniPMML != null && aJniPMML.PMMLMatter.Doc != null);
                //C# Boolean bUsingPMML = false;
                ...
                try {
                    ...
                    for ( ii = 0; ii < nColumns; ii++, bptr += (int) nBlockCoreColumnSize ) {
                        ...
                        //Java
                        col.DTyp = FieldMDEnums.eDTyp.FromInt(buffer.GetLayerInt(1));
                        //C# col.DTyp = FieldMDExt.eDTyp_FromInt((int) buffer.GetLayerInt(1));
                    ...
                    for ( jj = 0; jj < nColumns; jj++ ) {
                        switch ( aInputRecordSetMD.Column[jj].DTyp ) {
                            case Dbl:
                                ...
                                //Java
                                if ( lvd == null || lvd.isNaN() || Double.isInfinite(lvd) ) lvd = null;
                                //C# if ( lvd == null || Double.IsNaN(lvd.Value) || lvd == Double.MinValue || lvd == Double.MaxValue || Double.IsNegativeInfinity(lvd.Value) || Double.IsPositiveInfinity(lvd.Value) ) lvd = null;
                            ...
                            case Lng:
                                ...
                                //Java
                                if ( lvl == null || lvl.equals(Long.MIN_VALUE) || lvl.equals(Long.MAX_VALUE) ) lvl = null;
                                //C# if ( lvl == null || lvl == long.MinValue || lvl == long.MaxValue ) lvl = null;
                            ...
                            case Int:
                                ...
                                //Java
                                if ( lvi == null || lvi.equals(Integer.MIN_VALUE) || lvi.equals(Integer.MAX_VALUE) ) lvi = null;
                                //C# if ( lvi == null || lvi == int.MinValue || lvi == int.MaxValue ) lvi = null;
    ...
    /* <<< C# */
        ...
        throws com.WDataSci.WDS.WDSException
        {
            ...
            if ( this.RecordSet.Buffer.nDBBRequiredBytes > this.RecordSet.Buffer.Length
                    || (this.RecordSet.Buffer.nDBBRequiredBytes + this.RecordSet.Buffer.offset) > this.RecordSet.Buffer.Length )
                    ...
                    for ( jj = 0, j = 0; jj < nColumns; jj++, j++ ) {
                        ...
                        switch ( outRecordSetMD.Column[jj].DTyp ) {
                            ...
                            case Lng:
                                //case FieldMDEnums.eDTyp.Lng:
                                //Java
                                if ( lv == null ) lv = Long.MIN_VALUE;
                                //C# if ( lv == null ) lv = long.MinValue;
                            ...
                            case VLS:
                                //case FieldMDEnums.eDTyp.VLS:
                                String s="";
                                if (lv!=null) s=lv.toString();
                                buf.PutLayerVLenString(1, s, (int) outRecordSetMD.Column[jj].ByteMaxLength, 2);
                                break;
                            default:
