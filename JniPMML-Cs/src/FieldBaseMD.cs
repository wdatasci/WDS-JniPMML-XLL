...
namespace com.WDataSci.JniPMML
{
    ...
    class FieldBaseMD
    {
        ...
        public Boolean Equals(FieldBaseMD arg)
        {
            ...
            if ( !com.WDataSci.WDS.Util.MatchingNullityAndValueEquals(this.Format, arg.Format) ) return false;
            ...
            if ( !com.WDataSci.WDS.Util.MatchingNullity(this.HDF5DataType, arg.HDF5DataType) ) return false;
